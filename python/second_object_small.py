...
tertiary_d.qpos=[ 1.10912691, -0.0045432, 1.47421442,  0.61671887]
...
middle_d.qpos=[1.11833082, 0.13044702, 1.40058313,  0.72563158]
...
while time.time() - start_time < 10 and time.time()>5:
    ...
    leap_pos.set_allegro([ 0.09209763,  1.63068043,  0.06141792, -0.35889281,  0.13044702,  1.11833082,
  1.40058313,  0.72563158, -0.0045432,   1.10912691,  1.47421442,  0.61671887,
  1.56011711,  0.02613626,  0.63205873, -0.6948346 ])
...
F_middle = np.reshape([0, 0, 0.5, 0, 0, 0], [6, 1])
F_tertiary = np.reshape([0, 0, 0.5, 0, 0, 0], [6, 1])
